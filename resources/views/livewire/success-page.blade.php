            ...
            <div>
                ...
                <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="w-full px-4 mb-4 md:w-1/5">
                        ...
                        <p class="text-base font-semibold leading-4 text-green-600 dark:text-gray-400">
                        ...
                        <div class="flex flex-col w-full space-y-6 ">
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between w-full">
                                    ...
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">{{ Number::currency($tax, 'USD') }}</p>
                                </div>
                                <div class="flex items-center justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Shipping</p>
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">{{ Number::currency($shipping, 'USD') }}</p>
                                </div>
                            </div>
                            <div class="flex items-center justify-between w-full">
