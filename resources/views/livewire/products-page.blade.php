                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span class="text-green-600 dark:text-green-600">
                                                {{ Number::currency($product->price) }} <!--  , 'TL ' -->
                                            </span>
                                        </p>
                                    </div>
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                        ...
                                        <a wire:click.prevent="addItemToCart( {{ $product->id }})" href="#"
                                           class="text-gray-500 flex items-center space-x-2 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300">
                                            ...
                                            <span wire:loading.remove wire:target="addItemToCart( {{ $product->id }})">Add to Cart</span>
                                            <span wire:loading wire:target="addItemToCart( {{ $product->id }})">Adding...</span>
                                        </a>
